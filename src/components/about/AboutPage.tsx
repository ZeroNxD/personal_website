...
export const AboutPage = () => {
  ...
  return (
    <div className="flex flex-col gap-6 justify-center items-center">
      ...
      <div className="w-full border-2 rounded-lg bg-gradient-to-b from-gray-100/70 to-gray-200/70 dark:from-slate-800/70 dark:to-slate-900/70 border-gray-500 p-6 md:p-8 lg:p-10">
        <Information />
      </div>
    </div>
  )
